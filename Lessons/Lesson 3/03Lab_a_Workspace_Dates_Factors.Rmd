...
date_juneteenth <- (dmy(str_juneteenth <- "19 June 1865"))
date_juneteenth

class(date_juneteenth)
```
### The century issue
...
date_obj_past
#Bigger than 25, begin with 19 instead of 20
...
#aside from date info, have minute and second info - ymd_hms
...
class(sites$dow)
#Numeric, but not necessarily. Countiung days of week
...
#Recorded as factor, not real number. Not meaningful
...
#Much more relevant - tells us most days are 4th day of the week.
